...
const randomStringSource = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ123456789_+"

// Tools is the type used to istantiate this module. Any variable of this type
